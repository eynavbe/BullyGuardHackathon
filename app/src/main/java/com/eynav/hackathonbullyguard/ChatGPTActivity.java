...
public class ChatGPTActivity extends AppCompatActivity {
    ...
    private String accessToken = "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";
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, apiUrl, requestBody, new Response.Listener < JSONObject > () {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof ServerError && error.networkResponse != null && error.networkResponse.statusCode == 429) {
                    ...
                    int backoffTime = (int) Math.pow(2, retryCount) * 1000; // Exponential backoff formula
                    retryCount++;
